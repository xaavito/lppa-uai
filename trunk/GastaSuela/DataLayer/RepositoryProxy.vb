...
Public Class RepositoryProxy
    ...
    Public Sub BeginTransaction() Implements IRepository.BeginTransaction
        ...
        Utilidades.Output.Print("/Transacción al repositorio abierta")
    End Sub
    ...
    Public Sub Conectar() Implements IRepository.Conectar
        ...
        Utilidades.Output.Print("/Conexión al repositorio abierta")
    End Sub

    Public Sub Desconectar() Implements IRepository.Desconectar
        _repository.Desconectar()
        Utilidades.Output.Print("/Conexión al repositorio cerrada")
    End Sub

    Public Function ExecuteDataSet() As System.Data.DataSet Implements IRepository.ExecuteDataSet
        Utilidades.Output.Print(String.Format("/Ejecutando stored {0}", _repository.Nombre))
...
#Region "IDisposable Support"
    ...
    Public Sub Dispose() Implements IDisposable.Dispose
        _repository.Dispose()
        Utilidades.Output.Print("/Conexión liberada (Disposed)")
        Dispose(True)
